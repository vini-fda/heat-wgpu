...
const VERTICES: &[Vertex] = &[
    Vertex { position: [-1.0, 1.0, 0.0], color: [0.67059, 0.913725, 0.701961] }, // top left
    Vertex { position: [1.0, 1.0, 0.0], color: [1.0, 0.0, 0.0] }, // top right
    Vertex { position: [1.0, -1.0, 0.0], color: [0.0, 0.0, 1.0] }, // bottom right
    Vertex { position: [-1.0, -1.0, 0.0], color: [0.0, 1.0, 0.0] }, // bottom left
];
